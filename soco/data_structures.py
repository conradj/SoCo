...
class DidlPlaylistFavorite(DidlPlaylistContainer):

    """Class that represents a Sonos favorite music playlist.
    Added by Conrad Jackson (so that I can search for it when it breaks)
